...
validates them, writes the corresponding \texttt{.DAT} files, and assembles them into a SQL loading
script that can be downloaded by QA engineers. The standalone mode allows fully synthetic dataset
