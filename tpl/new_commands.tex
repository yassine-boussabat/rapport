...
\renewcommand{\arraystretch}{1.5} % Adjusts the line spacing in the table
...
\newcommand{\textLR}[1]{{\selectlanguage{english}#1}}

%================ Petri Net notation commands ================%
\providecommand{\preset}[1]{^\bullet#1}
\providecommand{\postset}[1]{#1^\bullet}
